...
#apache+php
apt-get -y install libapache2-mod-php5 php5 php5-common php5-dev php5-curl php5-gd php5-intl php-pear php5-imagick php5-mcrypt php5-memcache php5-ming php5-mysql php5-pspell php5-recode php5-snmp php5-sqlite php5-tidy php5-xmlrpc php5-xsl
php ./installer/php_mod_ming_conf_set.php
a2enmod rewrite
...
cp ./installer/proftpd_modules/mod_sftp.so /usr/lib/proftpd/
chmod 644 /usr/lib/proftpd/mod_sftp.so
cp ./installer/proftpd_modules/mod_tls.so /usr/lib/proftpd/
chmod 644 /usr/lib/proftpd/mod_tls.so
cp ./installer/proftpd_modules/mod_tls_memcache.so /usr/lib/proftpd/
chmod 644 /usr/lib/proftpd/mod_tls_memcache.so
