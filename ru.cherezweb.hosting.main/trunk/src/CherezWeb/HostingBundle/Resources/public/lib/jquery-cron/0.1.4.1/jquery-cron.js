...
(function($) {
    ...
    // options for period
    var str_opt_period = "";
    var periods = ["минута", "час", "день", "неделя", "месяц", "год"];
    ...
    var methods = {
        init : function(opts) {
            ...
            block["period"] = $("<span class='cron-period'>"
                    + "Период повтора <select name='cron-period'>" + custom_periods
            ...
            block["dom"] = $("<span class='cron-block cron-block-dom'>"
                    + " число <select name='cron-dom'>" + str_opt_dom
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["месяц"] = $("<span class='cron-block cron-block-month'>"
                    + " месяц <select name='cron-month'>" + str_opt_month
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["dow"] = $("<span class='cron-block cron-block-dow'>"
                    + " день недели <select name='cron-dow'>" + str_opt_dow
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
