...
class PaymentController extends Controller {
    ...
    public function makeAction(Request $request, Wallet $wallet) {
        ...
        if ($makePaymentForm->isValid()) {
            ...
            $robokassaMerchanLogin = $this->container->getParameter('cherez_web.billing.robokassa.merchan_login');
            $robokassaMerchanPass1 = $this->container->getParameter('cherez_web.billing.robokassa.merchan_pass_1');
            
            $mySecretCode = md5($robokassaMerchanPass1.$newPayment->getId().$this->container->getParameter('cherez_web.billing.secret'));
    ...
    public function resultAction(Request $request) {
        $robokassaMerchanPass2 = $this->container->getParameter('cherez_web.billing.robokassa.merchan_pass_2');
    ...
    public function failAction(Request $request) {
        ...
        if ($mySecretCode !== md5($robokassaMerchanPass1.$invId.$this->container->getParameter('cherez_web.billing.secret'))) {
            return $this->render('CherezWebBillingBundle:Payment:fail.html.twig', array(
